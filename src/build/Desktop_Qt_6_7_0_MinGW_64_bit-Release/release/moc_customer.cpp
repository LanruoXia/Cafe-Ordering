...
constexpr auto qt_meta_stringdata_CLASSCustomerENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "on_btnMenu_clicked",
    "on_btnMyOrder_clicked",
    "on_btnPlaceOrder_clicked",
    "on_btnPayAndOrder_clicked",
    "on_table_my_order_clicked",
    "QModelIndex",
    "index"
);
...
Q_CONSTINIT const QMetaObject Customer::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCustomerENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnMyOrder_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnPlaceOrder_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnPayAndOrder_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_table_my_order_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Customer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_btnMyOrder_clicked(); break;
        case 3: _t->on_btnPlaceOrder_clicked(); break;
        case 4: _t->on_btnPayAndOrder_clicked(); break;
        case 5: _t->on_table_my_order_clicked((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Customer::logOut; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
